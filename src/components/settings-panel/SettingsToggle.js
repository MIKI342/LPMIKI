// SettingsToggle: Este componente es un botón estilizado en forma de tarjeta que permite activar el panel de configuración de la aplicación.
// Al hacer clic en este botón, se abre el `SettingsPanel`, el cual permite al usuario personalizar varios aspectos de la interfaz
// (como el tema, el modo RTL, entre otros). Utiliza el contexto global `useAppContext` para acceder a la función `setConfig`
// y actualizar el estado de visualización del panel de configuración (`showSettingPanel`).
