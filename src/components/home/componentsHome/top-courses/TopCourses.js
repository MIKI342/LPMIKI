...
import TopCoursesTable from 'components/home/componentsHome/top-courses/TopCoursesTable';
        ...
        <Card.Body className="p-0">
          <Tab.Content>
            <Tab.Pane unmountOnExit eventKey="popularPaid">
              <TopCoursesTable
                tableData={tableData ? tableData.slice(0, 4) : []}
              />
            </Tab.Pane>
            <Tab.Pane unmountOnExit eventKey="popularFree">
              <TopCoursesTable
                tableData={tableData ? tableData.slice(4, 8) : []}
              />
            </Tab.Pane>
            <Tab.Pane unmountOnExit eventKey="topPaid">
              <TopCoursesTable
                tableData={tableData ? tableData.slice(8, 12) : []}
              />
            </Tab.Pane>
            <Tab.Pane unmountOnExit eventKey="topFree">
              <TopCoursesTable
                tableData={tableData ? tableData.slice(12, 16) : []}
              />
            </Tab.Pane>
          </Tab.Content>
        </Card.Body>
